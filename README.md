...
│       │   ├── enum/                            # Enum-классы статусов, ролей и типов вызовов
│       │   │   ├── call_type.py                 # Типы и статусы LLM-вызовов
│       │   │   ├── clinical_protocol_status.py  # Статусы обработки клинических протоколов
│       │   │   ├── report_status.py             # Статусы генерации отчетов
│       │   │   └── role.py                      # Роли пользователей
